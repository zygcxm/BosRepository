...
public class Standard {
	...
	public Standard(Integer id, String name, Integer minWeight,
			Integer maxWeight, Integer minLength, Integer maxLength,
			Date operatingTime, String operator, String operatingCompany) {
		super();
		this.id = id;
		this.name = name;
		this.minWeight = minWeight;
